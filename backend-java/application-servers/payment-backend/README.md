...
Java backend for backend part for the Payment Infrastructure project.
This project is using JHipster so it was created with a JHipster generator. Quick start guide: https://www.jhipster.tech/
You need an empty MySQL DB to run the project as a server (local or in the network) + Java 1.8 and for front-end npm. Configuration is in:
src/main/resources/config/application-dev.properties
For running main in SmartContractExperiment.java DB is not needed.
SmartContractExperiment.java - I'm trying to make work communication with Ethereum network in this class. Check it out. 
SmartContractService.java - future place to work with Smart Contracts
com.zurichdev.payback.ethereum - best place to put generated smart contracts for now

# payback - JHipster documentation part
...
To optimize the payback application for production, run:
